...
export function HeroSection() {
    ...
    return (
        ...
        >
            ...
            >
                <div className="mb-8 relative w-32 h-32 md:w-48 md:h-48 mx-auto hover:scale-110 transition-transform duration-500 bg-black rounded-full mix-blend-screen">
                    <img
