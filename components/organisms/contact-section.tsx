...
const socialLinks = [
    ...
    { href: "https://instagram.com/mdeangelis", icon: "icon_social_instagram.svg", label: "Instagram" },
    { href: "https://youtube.com/@mdeangelis", icon: "icon_social_youtube.svg", label: "YouTube" },
