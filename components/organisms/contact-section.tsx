                ...
                <div className="flex justify-center md:justify-start gap-4">
                    {[
                        ...
                        <Link 
                            ...
                            className="bg-background border border-white/10 p-4 rounded-xl hover:scale-110 hover:border-primary hover:shadow-[0_0_20px_rgba(255,159,28,0.3)] transition-all duration-300"
                        >
                            <Image 
